"""
Django settings for the helli5 project.

This module contains the settings for the helli5 project. It defines the
installed apps, middleware, database, and other configuration options.
"""
